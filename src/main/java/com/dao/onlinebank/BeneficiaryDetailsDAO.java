...
public class BeneficiaryDetailsDAO 
{
	...
	public int saveBridge(String accid,long bid)
	{
	...
	public List<Object> retriveBenificiary(String accid)
	{
	...
	public int updateReceiver(double ramt,long accnumber)
	{


		String query="update account set amount=amount+' "+ramt+" ' where ACCOUNTNUMBER = ' "+accnumber+" ' ";
	...
	public int updateSender(double samt, long accid)
	{

		String query="update account set amount=amount-' "+samt+" ' where accid = ' "+accid+" ' ";
